...
import (
    ...
    "os"
    "encoding/base64"
    "cert-secret-applier/pkg/config"
)
...
func Run(ctx context.Context) error {
    if err := config.LoadConfig("pkg/config", "config"); err != nil {
		return err
	}
    ...
    kubernetesHost := cfg.Kubernetes.Service.Host
    kubernetePort := cfg.Kubernetes.Service.Port.HTTP
